...
df = pd.read_csv(os.path.join(CARPETA_DATOS,'Datos_Dia_mm.csv')) # Cargar los datos desde el archivo
print("\nDatos faltantes:") 
...
Nuevo_archivo = os.path.join(CARPETA_DATOS,'Datos_Dia_mm_validados.csv')
